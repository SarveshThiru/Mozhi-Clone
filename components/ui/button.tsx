  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        primary: "bg-[#6C4DFF] text-white hover:bg-[#5D42EB] border-[#4E36D2] border-b-4 active:border-b-0",
        primaryOutline: "bg-white text-[#6C4DFF] hover:bg-slate-100 border border-[#6C4DFF]",
        secondary: "bg-[#4A6BFF] text-white hover:bg-[#3D5EE8] border-[#354FD9] border-b-4 active:border-b-0",
        secondaryOutline: "bg-white text-[#4A6BFF] hover:bg-slate-100",
        danger: "bg-rose-500 text-primary-foreground hover:bg-rose-500/90 border-rose-600 border-b-4 active:border-b-0",
        dangerOutline: "bg-white text-rose-500 hover:bg-slate-100",
        super: "bg-[#FFC033] text-[#1A1A2E] hover:bg-[#F7B510] border-[#E0A100] border-b-4 active:border-b-0",
        superOutline: "bg-white text-[#FFC033] hover:bg-slate-100",
        ...
        sidebarOutline: "bg-[#6C4DFF]/10 text-[#6C4DFF] border-[#6C4DFF]/30 border-2 hover:bg-[#6C4DFF]/15 transition-none"
      },
      size: {
